			...
			const transformedData: MatchDetailData = {
				...
				home: {
					...
					name:
						...
						"Home Team",
					shortName:
						rawData.general?.homeTeam?.shortName ||
						rawData.home?.shortName ||
						rawData.home?.name ||
						"HOME",
				...
				away: {
					...
					name:
						...
						"Away Team",
					shortName:
						rawData.general?.awayTeam?.shortName ||
						rawData.away?.shortName ||
						rawData.away?.name ||
						"AWAY",
				...
				status: {
					utcTime:
						rawData.general?.matchTimeUTC ||
						rawData.status?.utcTime ||
				...
				tournament: {
					...
					name:
						rawData.general?.leagueName ||
						rawData.tournament?.name ||
						"Tournament",
				...
				referee: rawData.general?.referee
					...
					: undefined,
				events: Array.isArray(rawData.content?.matchFacts?.events)
					? rawData.content.matchFacts.events
					: [],
